...
<!-- Power BI dashboard -->
<h2> Power BI dashboard for Domino's Pizza sales (simulated data from <a href="https://urbizedge.com/sample-power-bi-project-on-analysing-sales-data-by-branch-product-and-target/">Urbizedge</a>) </h2>
